...
export function getAuthorizationUrl() {
    ...
    const params = new URLSearchParams({
        ...
        response_type: 'code',
        // Agent-specific scopes (from OAuth docs):
        // - read,write: Base access
        // - app:assignable: Allows agent to be assigned/delegated issues
        // - app:mentionable: Allows agent to be @mentioned
